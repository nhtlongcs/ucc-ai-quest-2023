...
def test_pure_model(model_name):
    cfg = CN(
        {
            "data": {
                "name": "SegDataset",
...
# eval model [SegResNet50, ResNet50VicregL, ResNet50VicregL2, SegResNet101]
@pytest.mark.order(3)
@pytest.mark.parametrize(
    "model_name",
    [
...
def test_pure_model_eval(model_name, bs=2):
    cfg = CN(
        {
            "data": {
                "name": "SegDataset",
...
if __name__ == "__main__":
    test_pure_model_eval(model_name="SegResNet50", bs=2)
