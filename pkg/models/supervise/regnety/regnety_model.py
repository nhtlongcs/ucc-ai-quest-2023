...
from pkg.models.supervise.regnety.regnety_encoder import RegNetY_SEER
...
class Model(nn.Module):
    def __init__(self, num_classes, **kwargs):
        super().__init__()
        self.encoder = RegNetY_SEER()
        self.head = UPerHead(self.encoder._out_channels, num_classes=num_classes)
...
class RegNetY_UPerNet(SuperviseModel):
